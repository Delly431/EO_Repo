...
<div id="qa1" style="font-size : 14px;"> 
   ...
   <ul style="list-style-image: url('images/small_icon.png');">
   <li>
   Responsible for the creation, direction and execution of the community's vision, mission, and values through establishing the community's key priorities to ensure all administrative and targeted improvements 
   work toward furthering Exiled Order’s long term goals.
   </li>
   <li>
   Oversees the Community Development and Security on a Daily, Monthly, Quarterly and Annual basis. Such operations include oversight of Operations and Justice department infrastructures, policies and procedures, 
   and ensuring that community needs are addressed to ensure the best possible experience for members. Along with calculating financial risks, planning and record-keeping for invoices to ensure proper performance 
   on a daily basis.
   </li>
   <li>
   ...
   <li>
   Possesses the authority to evict any member with administrative power of any sort from their department and/or sector for reasons of corruption, abuse of power, abuse of members, abuse of resources, 
   lack of activity, state of emergency or for any other reason deemed inappropriate by an administrative board.
   </li>
   <li>
   ...
   <ul style="list-style-image: url('images/small_icon.png');">
   <li>
   Have been in the community for at least three (3) years to be nominated for the position if one the current Leadership leaders have left or has requested a transfer of their assignment.
   </li>
   </ul>
   <h1>Security Clearance:</h1>
   <ul style="list-style-image: url('images/small_icon.png');">
...
<div id="qa3"> 
   ...
   <li>
   Requires the Rank of Senior Member 1st Grade.
   </li>
   <li>
   Must be at least 20 years of age.
   </li>
...
<div id="qa4">
   ...
   <li>
   Deals with any high-level issues and concerns that may arise and acts as a liaison between Operations and the EO Administrators and  Leadership.
   </li>
   <li>
   ...
   <li>
   Must be nominated/selected from the Administration Staff and Operations Foreman.
   </li>
   <li>
