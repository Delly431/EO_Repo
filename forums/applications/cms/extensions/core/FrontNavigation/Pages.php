...
class _Pages extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
	...
	public static function configuration( $existingConfiguration, $id = NULL )
	{
		...
		return array(
			...
			new \IPS\Helpers\Form\Radio( 'menu_title_page_type', isset( $existingConfiguration['menu_title_page'] ) ? $existingConfiguration['menu_title_page'] : 0, NULL, array( 'options' => array( 0 => 'menu_title_page_inherit', 1 => 'menu_title_page_custom' ), 'toggles' => array( 1 => array( 'menu_title_page' ) ) ), NULL, NULL, NULL, 'menu_title_page_type' ),
	...
	public function canView()
	{
		...
		/* Inherit from page */
		$store = \IPS\cms\Pages\Page::getPageUrlStore();
