...
class _upcomingEvents extends \IPS\Widget\PermissionCache
{
	...
	public function render()
	{
		...
		$events = \IPS\calendar\Event::retrieveEvents( $_today, $endDate, $calendars, ( isset( $this->configuration['maximum_count'] ) AND $this->configuration['maximum_count'] > 0 ) ? $this->configuration['maximum_count'] : 5, FALSE );
