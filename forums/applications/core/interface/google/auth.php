...
{
	\IPS\Output::i()->redirect( \IPS\Http\Url::internal( "app=core&module=system&controller=login&loginProcess=google&base={$base[0]}&state={$base[1]}&code=" . urlencode( \IPS\Request::i()->code ), $base[0], 'login', NULL, \IPS\Settings::i()->logins_over_https ) );
}