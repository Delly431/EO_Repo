...
class _Facebook extends ProfileSyncAbstract
{
	...
	public function photo()
	{
		...
		{
			\IPS\Log::i( LOG_ERR )->write( "Facebook photo sync error: " . $e->getMessage(), 'facebook' );
	...
	public function name()
	{
		...
		{
			\IPS\Log::i( LOG_ERR )->write( "Facebook name fetch error: " . $e->getMessage(), 'facebook' );
	...
	public function status()
	{
		...
		{
			\IPS\Log::i( LOG_ERR )->write( "Facebook status import error: " . $e->getMessage(), 'facebook' );
		}
		return NULL;
	}
