<?php
/**
 * @brief		Moderator Control Panel Member Management Extension: Queued Users
...
class _Queued
{
	...
	{
		/* Create the table */
		$table = new \IPS\Helpers\Table\Db( 'core_members', \IPS\Http\Url::internal( 'app=core&module=modcp&tab=members&area=queued' ), 'mod_posts<>0' );
