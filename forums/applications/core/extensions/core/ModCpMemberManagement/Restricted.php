<?php
/**
 * @brief		Moderator Control Panel Member Management Extension: Restricted Users
...
class _Restricted
{
	...
	{
		/* Create the table */
		$table = new \IPS\Helpers\Table\Db( 'core_members', \IPS\Http\Url::internal( 'app=core&module=modcp&tab=members&area=restricted' ), 'restrict_post<>0' );
