...
class _developer extends \IPS\Dispatcher\Controller
{
	...
	protected function _manageModules( $location )
	{
		...
		if ( isset( \IPS\Request::i()->delete ) )
		{
			...
			/* delete all the other stuff http://community.invisionpower.com/resources/bugs.html/_/4-0-0/1019-deleting-a-controller-does-not-delete-its-menu-entry-r48752 */
