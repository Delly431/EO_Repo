...
class _emails extends \IPS\Dispatcher\Controller
{
    ...
    public function emailPreview()
    {
        ...
        $output	= call_user_func_array( 'IPS\\Theme\\email_html_core_emailWrapper', array( NULL, new \IPS\Member, $body, NULL, FALSE, '', \IPS\Email::buildFromContent( '' ) ) );
