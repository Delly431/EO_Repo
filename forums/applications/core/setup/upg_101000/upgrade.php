...
class _Upgrade
{
	...
	{
		return "Initiating search index rebuild";
	}

	/**
	 * Step 4: Upgrade emoticons
	 *
	 * @return	array	If returns TRUE, upgrader will proceed to next step. If it returns any other value, it will set this as the value of the 'extra' GET parameter and rerun this step (useful for loops)
	 */
	...
	/**
	 * Step 5: Populate default streams
	 *
	 * @return	array	If returns TRUE, upgrader will proceed to next step. If it returns any other value, it will set this as the value of the 'extra' GET parameter and rerun this step (useful for loops)
	 */
	...
	/**
	 * Step 7: Adjust email SMTP host/protocol
	 *
	 * @return	array	If returns TRUE, upgrader will proceed to next step. If it returns any other value, it will set this as the value of the 'extra' GET parameter and rerun this step (useful for loops)
	 */
	...
	/**
	 * Step 8: Remove some legacy columns if they still exist
	 *
	 * @return	array	If returns TRUE, upgrader will proceed to next step. If it returns any other value, it will set this as the value of the 'extra' GET parameter and rerun this step (useful for loops)
	 */
	...
	public function finish()
	{
		...
		if ( \IPS\Application::appIsEnabled('cms') )
		{
			$rootId = \IPS\Db::i()->insert( 'core_menu', array(
				'app'			=> 'core',
				'extension'		=> 'CustomItem',
				'config'		=> json_encode( array( 'menu_custom_item_url' => 'app=cms&module=pages&controller=page', 'internal' => 'content' ) ),
				'position'		=> ++$maxPosition,
				'parent'		=> NULL,
				'permissions'	=> '*',
			) );
