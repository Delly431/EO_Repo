...
class _Upgrade
{
	...
	public function step1()
	{
		...
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(1, 'Twitter', 'http://twitter.com/home?status={title}%20{url}', 'twitter', 1, 1, '',1)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(2, 'Facebook', 'http://www.facebook.com/share.php?u={url}', 'facebook', 1, 2, '',1)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(3, 'Digg', 'http://digg.com/submit?phase=2&amp;url={url}&amp;title={title}', 'digg', 1, 3, '',1)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(4, 'Del.icio.us', 'http://del.icio.us/post?v=2&amp;url={url}&amp;title={title}', 'delicious', 1, 4, '',1)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(5, 'Reddit', 'http://reddit.com/submit?url={url}&amp;title={title}', 'reddit', 1, 5, '',1)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(6, 'StumbleUpon', 'http://www.stumbleupon.com/submit?url={url}&title={title}', 'stumble', 1, 6, '',1)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(8, 'Email', '', 'email', 1, 7, '',1)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(9, 'Buzz', '', 'buzz', 1, 3, '', 1)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(10, 'Print', '', 'print', 1, 10, '', 0)" );
		\IPS\Db::i()->query( "INSERT INTO core_share_links VALUES(11, 'Download', '', 'download', 1, 11, '', 0)" );
		...
		$toRun = \IPS\core\Setup\Upgrade::runManualQueries( array( array(
			...
			'query' => "ALTER TABLE " . \IPS\Db::i()->prefix . "members CHANGE COLUMN language language MEDIUMINT(4) NULL DEFAULT NULL,
				...
				ADD INDEX twitter_id (twitter_id),
