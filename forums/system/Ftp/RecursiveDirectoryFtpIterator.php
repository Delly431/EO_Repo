...
class _RecursiveDirectoryFtpIterator extends \IPS\Ftp\FtpSplFileInfo implements \RecursiveIterator
{
	 ...
	 *
	 * @return \RecursiveDirectoryFtpIterator
	 */
	...
	public function rewind()
	{
		...
		foreach( $names as $k => $name )
		{
			...
			$this->contents[]	= new \IPS\Ftp\RecursiveDirectoryFtpIterator( $this->ftpObject, $this->getItemname( $name ), self::getTypeFromRaw( $types[ $k ] ) );
		}
	}
