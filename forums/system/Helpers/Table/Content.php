...
class _Content extends Table
{
	 ...
	 * @return	void
	 */
	public function __construct( $class, \IPS\Http\Url $baseUrl, $where=NULL, \IPS\Node\Model $container=NULL, $includeHidden=NULL, $permCheck='view', $honorPinned=TRUE, $showMovedLinks=FALSE )
	{
		/* Init */
		$this->include = array();
		$this->class = $class;
