...
abstract class _CustomField extends \IPS\Node\Model
{
	...
	{		
		...
		$toggles = array(
			...
			'Select'		=> array( 'pf_not_null', 'pf_content', 'pf_multiple', "{$form->id}_header_pfield_displayoptions", 'pf_format' ),
	...
	public function claimAttachments( $id1 = NULL )
	{
		...
		\IPS\File::claimAttachments( $options['autoSaveKey'], $id1, $this->id );
	}
	...
	public function displayValue( $value=NULL )
	{
		switch ( $this->type )
		{
			...
			case 'Select':
				...
				{
					return htmlspecialchars( \IPS\Lang::wordbreak( $value ), \IPS\HTMLENTITIES | ENT_QUOTES, 'UTF-8', FALSE );
				}
			...
			case 'TextArea':
				return \IPS\Lang::wordbreak( nl2br( htmlspecialchars( $value, \IPS\HTMLENTITIES | ENT_QUOTES, 'UTF-8', FALSE ) ) );
			...
			default:
				return \IPS\Lang::wordbreak( htmlspecialchars( $value, \IPS\HTMLENTITIES | ENT_QUOTES, 'UTF-8', FALSE ) );
		}
	}
}