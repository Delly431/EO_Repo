...
<div id="roster_disp">
	<center><h1><img src="assets/images/Staff.png" alt="Staff"/></h1></center>
...
$conn->close();
?>
    <center><h1><img src="assets/images/Members.png" alt="Members"/></h1></center>
<?php
// Create connection
$conn = new mysqli($servername, $username, $password, $dbname);
// Check connection
...
$sql = "SELECT * FROM eo_roster.roster_members where rank_name not in ('GM', 'Officer','Main Raider', 'Group 2 Raider', 'Casual', 'Trial')";
$result = $conn->query($sql);
$loopResult = '';
$location='';
if ($result->num_rows > 0) {
